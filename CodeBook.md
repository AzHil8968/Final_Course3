 This file includes information about variables in "average_of_each_variable.txt" (and "average_of_each_variable.csv" in .csv format) file as the output of run_analysis.R.
